...
for (let i = 0; i < letters.length; i++) {
    ...
    if (i < 26) {
        // parser fonts have only capital letters for blackboard bold and script.
    ...
    // TODO: Add bold script when it is supported by a parser font.
}
// "k" is the only double struck lower case letter in the parser fonts.
