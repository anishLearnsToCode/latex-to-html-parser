...
// Unicode middle dot
// The parser fonts do not contain U+00B7. Instead, \cdotp displays
...
// The parser fonts have corners at codepoints that don't match Unicode.
...
defineMacro("\\dots", function(context) {
    ...
    // However, in parser, \textellipsis and \ldots behave the same
...
// TODO: Doesn't normally work in math mode because \@ fails.  parser doesn't
...
// New parser logo based on tweaking LaTeX logo
defineMacro("\\parser", "\\textrm{\\html@mathml{" +
    `K\\kern-.17em\\raisebox{${latexRaiseA}}{\\scriptstyle A}` +
    "\\kern-.15em\\TeX}{parser}}");
...
//////////////////////////////////////////////////////////////////////
// MathML alternates for parser glyphs in the Unicode private area
...
// glyph. Those glyphs do not exist in the parser fonts. Hence the macros.
