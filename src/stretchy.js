...
// Many of the SVG images have been adapted from glyphs.
...
// Very Long SVGs
//    Many of the stretchy wide elements use a long SVG image and an
...
// In the parserImagesData object just below, the dimensions all
// correspond to path geometry inside the relevant SVG.
// For example, \overrightarrow uses the same arrowhead as glyph U+2192
// from the parser Main font. The scaling factor is 1000.
// That is, inside the font, that arrowhead is 522 units tall, which
// corresponds to 0.522 em inside the document.

const parserImagesData: {
...
const svgSpan = function(
    ...
    function buildSvgSpan_(): {
        ...
        if (utils.contains(["widehat", "widecheck", "widetilde", "utilde"],
            ...
            const data = parserImagesData[label];
            ...
            if (numSvgChildren === 1) {
                ...
                throw new Error(
                    `Correct parserImagesData or update code here to support
