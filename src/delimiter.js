...
const makeSqrtImage = function(
    ...
    if (delim.type === "small") {
        // Get an SVG that is derived from glyph U+221A in font parser-Main.
        ...
        // These SVGs come from fonts: parser_Size1, _Size2, etc.
    ...
    return {
        ...
        // should use the thicker surd symbols from e.g. parser_Main-Bold, and
        // have thicker rules.
